...
from .. import config as centaur_config
...
def get_project_root() -> Path:
    ...
    return centaur_config.PROJECT_ROOT
...
def get_data_dir(subdir: str = 'work') -> Path:
    ...
    if subdir == 'raw':
        return centaur_config.DATA_RAW_DIR
    elif subdir == 'work':
        return centaur_config.DATA_WORK_DIR
    elif subdir == 'diagnostics':
        return centaur_config.DIAGNOSTICS_DIR
    else:
...
def get_output_dir() -> Path:
    ...
    return centaur_config.FIGURES_DIR


def get_figures_dir() -> Path:
    """Get the manuscript figures directory."""
    return centaur_config.MANUSCRIPT_FIGURES_DIR
...
def load_config(config_name: str) -> dict:
    ...
    """
    import yaml
    config_path = centaur_config.MANUSCRIPT_DIR / 'journal_configs' / f'{config_name}.yml'
...
def save_config(config: dict, config_name: str, config_dir: str = 'journal_configs') -> Path:
    ...
    config_path = centaur_config.MANUSCRIPT_DIR / config_dir / f'{config_name}.yml'
