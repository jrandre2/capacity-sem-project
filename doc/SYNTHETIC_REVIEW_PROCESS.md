...
This project uses synthetic peer reviews generated by LLMs (Claude, GPT-4) to stress-test manuscripts before submission to **Public Administration Review (PAR)**. The system supports multiple manuscript approaches, each with its own review history.

### Active Manuscripts

| Manuscript | Directory | Review Tracking |
|------------|-----------|-----------------|
| **Velocity** | `manuscript_velocity/` | `doc/reviews/velocity/` |

See [reviews/README.md](reviews/README.md) for the full manuscript index. This proactive approach helps:
...
```bash
# Specify manuscript with --manuscript flag
...
- `manuscript_velocity/REVISION_TRACKER.md` - Detailed tracking (for velocity manuscript)
...
All review commands require `--manuscript` to specify which manuscript to review.
...
```bash
python src/pipeline.py review_new --manuscript velocity --focus par_general
python src/pipeline.py review_new --manuscript velocity --focus methods
python src/pipeline.py review_new --manuscript velocity --focus policy
python src/pipeline.py review_new --manuscript velocity --focus clarity
```
...
Each manuscript has its own review tracking:
...
doc/reviews/{name}/
├── README.md                    # Manuscript-specific review index
...
| File | Purpose |
|------|---------|
| `manuscript_velocity/REVISION_TRACKER.md` | Current review tracking |
| `doc/reviews/velocity/README.md` | Velocity review index |
| `doc/reviews/velocity/archive/` | Archived velocity reviews |
...
| `doc/reviews/README.md` | Index of all manuscripts |
