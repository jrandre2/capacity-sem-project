...
**Our Response:**
Partially addressed in this pass. The manuscript now adds Appendix Table A2 to
...
**Our Response:**
Partially addressed in this pass. The manuscript now states the exact workload
...
**Our Response:**
Partially addressed in this pass. Appendix Table A4 now explains how state-
...
**Our Response:**
Still pending. The paper now treats the spatial figures more explicitly as
secondary descriptive material and removes the old governance-risk ranking table
from the main body, but the full figure set has not yet been reduced to the
