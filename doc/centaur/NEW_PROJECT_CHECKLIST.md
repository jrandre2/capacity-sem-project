...
- [ ] Test: `python src/pipeline.py centaur ingest_data`
...
- [ ] Test: `python src/pipeline.py centaur link_records`
...
- [ ] Test: `python src/pipeline.py centaur build_panel`
...
- [ ] Test: `python src/pipeline.py centaur run_estimation`
...
- [ ] Test: `python src/pipeline.py centaur estimate_robustness`
...
- [ ] Test: `python src/pipeline.py centaur make_figures`
...
- [ ] Run `python src/pipeline.py centaur validate_submission --journal {journal} --report`
- [ ] Address any validation warnings
- [ ] Verify word count meets requirements
- [ ] Check abstract length
- [ ] Run synthetic peer review: `python src/pipeline.py centaur review_new --focus {focus}`
