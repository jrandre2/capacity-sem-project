...
python src/pipeline.py centaur run_estimation --tier complex

# Force simple tier for speed (accepts lower quality)
python src/pipeline.py centaur make_figures --tier simple
```
...
python src/pipeline.py centaur run_estimation --supervision human-approved
python src/pipeline.py centaur run_estimation --autonomous

# Override model tier
python src/pipeline.py centaur draft_results --tier complex
python src/pipeline.py centaur make_figures --tier simple

# Combine overrides
python src/pipeline.py centaur review_new --supervision supervised --tier complex

# Future configuration views
future config view: orchestration
future config view: tiers
```
