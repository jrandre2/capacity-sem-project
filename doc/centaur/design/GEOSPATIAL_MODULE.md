...
python src/pipeline.py centaur link_records --match-type spatial --predicate within

# s03_estimation with Conley SE
python src/pipeline.py centaur run_estimation --conley-se --conley-cutoff 50

# s05_figures with maps
python src/pipeline.py centaur make_figures --include-maps --basemap satellite
```
